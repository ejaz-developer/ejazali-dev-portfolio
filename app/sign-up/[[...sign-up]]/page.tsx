...
export default function SignUpPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--black)] relative overflow-hidden">
      ...
      {/* Gradient Orbs */}
      <div className="absolute -top-40 -right-40 w-[400px] h-[400px] bg-[var(--orange-web)]/15 rounded-full blur-[100px]" />
      <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-[var(--oxford-blue)]/20 rounded-full blur-[120px]" />

      <div className="relative z-10">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-[var(--white)] mb-2 font-mono">
            Join <span className="text-[var(--orange-web)]">DevForge</span>
          </h1>
          <p className="text-[var(--platinum)]/70">Create an account to get started</p>
        </div>
        <SignUp
          appearance={{
            elements: {
